...
#chat........
        ...
        subprocess.call(["termux-tts-speak","i am busy with you "])        
         ...
         subprocess.call(["termux-tts-speak","made by Arirama selvam ,India,tamilnadu,Thuthoocurin "])
...
#termux api
     ...
     elif "call Vani" in inp:
         os.system("termux-telephony-call +919791874082")
     elif "call Kumar" in inp:
         os.system("termux-telephony-call +919482345776")
     elif "enable torch" in inp:
         os.system("termux-torch on")
     elif "disable torch" in inp:
         os.system("termux-torch off")
     elif "call vani" in inp:
         os.system("termux-telephony-call +9191874082")
     elif "enable wifi" in inp:
         os.system("termux-wifi-enable true")
     elif "disable wifi" in inp:
         os.system("termux-wifi-enable false")
     elif "vibrate" in inp:
         subprocess.call(["termux-vibrate"])
     elif "send SMS Vani" in inp:
         os.system("termux-sms-send -n +919791874082 hi ")
